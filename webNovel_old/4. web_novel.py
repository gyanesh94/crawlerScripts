...
"""
http://www.chinanovel.net/
1. God and Devil World
"""
...
def get_urls():
	url = "http://chinanovel.net/index.php/god-and-devil-world/godanddevilworld/chapter-{}/"
	start = 140
	end = 150
	l = []
	n = [101,102] + range(104,108) + range(112,117) + range(118,139) + range(140,150)
